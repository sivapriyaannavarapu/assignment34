...
const RefundItem = ({ label, value }) => (
    <div
        className="d-flex align-items-center justify-content-start mb-2 ps-3"
        style={{ gap: "150px" }} // Adjust this for spacing between label and value
    >
        {/* Label */}
...
//                     <RefundItem label="Material" value={'N/A'} />
//                 </div>
//             )}
//         </div>
//     );
