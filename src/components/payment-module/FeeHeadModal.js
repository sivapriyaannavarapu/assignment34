...
const FeeHeadModal = ({ showModal, setShowModal, feeHeads, addFeeItem }) => {
  ...
  return (
    <div
      className="parent d-flex flex-column justify-content-end align-items-center"
      style={{
        height: '100%',
        width: '100%',
        background: 'linear-gradient(46deg, rgba(33, 33, 33, 0.84) 0%, rgba(66, 66, 66, 0.24) 178.98%)',
      }}
    >
