...
const PaymentInformation = () => {
    ...
    return (
        <div className="payment_information px-2 border-start border-top">
            {/* Header */}
            <div className="d-flex align-items-center gap-2 border-bottom border-bottom-custom mb-3 mt-3 ms-1">
                ...
                <h6 className="text-dark mt-2">Information</h6>
            </div>

            <div className="card shadow-sm border-1 rounded-3 p-1">
                {/* Header */}
                <div
                    className="d-flex justify-content-between align-items-center px-3 pt-3 mx-2"
                    role="button"
  ...
  />
                ...
                {isOpen && (
                    <div className="card-body pt-2 pb-3">
                        <div className="mb-3 d-flex justify-content-between align-items-center custoum-heading border-top pt-3">
                            <strong>Select Class</strong>
                            <select className="form-select form-select-sm" style={{ width: "132px" ,color:"#000000" ,fontWeight:"600", backgroundColor:'#F2F2F2'}}>
...
//                         {[
//                             ["Course Fee", 'N/A'],
//                             ["Additional Amount", 'N/A'],
//                             ["Concession", 'N/A'],
//                             ["Net Fee", 'N/A'],
//                             ["Service Tax Paid", 'N/A'],
//                             ["Fee Paid", 'N/A'],
//                             ["Fee Refunded", 'N/A'],
//                             ["Over All Due", 'N/A'],
//                         ].map(([label, value], index) => (
