      ...
      <Grid container spacing={2}>
        <Grid item xs={3} sx={{ mt: 2, width: '26%' }}>
          <TextField
            ...
            onBlur={handleBlur}
            error={touched.feeItems?.[index]?.amount && !!errors.feeItems?.[index]?.amount}
            helperText={touched.feeItems?.[index]?.amount && errors.feeItems?.[index]?.amount}
            onKeyDown={(e) => {
        ...
        <Grid item xs={9} sx={{ mt: 2, width: '71.9%' }}>
          <TextField
            ...
            onChange={handleChange}
            onBlur={handleBlur}
            error={touched.feeItems?.[index]?.description && !!errors.feeItems?.[index]?.description}
            helperText={touched.feeItems?.[index]?.description && errors.feeItems?.[index]?.description}
          />
        </Grid>
      </Grid>
    </Box>
